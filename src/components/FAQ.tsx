   ...
   const faqs = [
    {
      ...
      answer: "Зарегистрируйтесь, получите бесплатный пробный период на 14 дней. Наши специалисты помогут с настройкой и обучат персонал."
    },
    {
    ...
    },
    {
      ...
      answer: "Стоимость зависит от выбранного тарифа. Доступны планы от 16$ в месяц. Все тарифы включают техподдержку 24/7."
    },
    {
